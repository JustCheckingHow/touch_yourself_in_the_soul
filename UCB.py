...
sentence = "Aplikacja ucząca się gustu użytkownika w celu zaproponowania mu wartych zobaczenia eksponatów"
print(len("Aplikacja ucząca się gustu użytkownika w celu zaproponowania mu wartych zobaczenia eksponatów".split(' ')))
